...
2026-09-20. The packaged text lists the exact resolved coordinates, including
...
| Bouncy Castle provider | 1.79 | Bouncy Castle License (MIT) | [Bouncy Castle](https://github.com/bcgit/bc-java/tree/r1rv79) |
| MBassador | 1.3.0 | MIT | [MBassador](https://github.com/bennidi/mbassador/tree/1.3.0) |
| SLF4J API | 2.0.9 | MIT | [SLF4J](https://www.slf4j.org/) |
...
| Apache Commons Compress, Codec, IO and Lang | 1.28.0; 1.19.0; 2.20.0; 3.18.0 | Apache-2.0 | [Apache Commons](https://commons.apache.org/) |
...
The packaged notices preserve the four Apache Commons `NOTICE.txt` files,
component-specific MIT/BSD notices, and the Media3 Sonic attribution. Common
